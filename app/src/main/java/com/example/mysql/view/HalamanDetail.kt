package com.example.mysql.view
...
import com.example.mysql.viewmodel.StatusUIDetail
import com.example.mysql.viewmodel.provider.PenyediaViewModel
    ...
    Scaffold(
        ...
        Box(
            ...
            BodyDetailDataSiswa(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(bottom = 96.dp) // 🔥 ruang FAB
...
@Composable
fun BodyDetailDataSiswa(statusUiDetail: StatusUIDetail, onDelete: () -> Job, modifier: Modifier) {
